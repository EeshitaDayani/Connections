...
export const words: Word[] = [
  ...
  { id: 5, text: "MISSING", category: 2, selected: false, matched: false, color: "bg-green-500" },
  { id: 6, text: "CREW", category: 2, selected: false, matched: false, color: "bg-green-500" },
  { id: 7, text: "TINKER", category: 2, selected: false, matched: false, color: "bg-green-500" },
  { id: 8, text: "FIGHTER", category: 2, selected: false, matched: false, color: "bg-green-500" },
